...
This application provides an example of Azure RTOS USBX stack usage on P-NUCLEO-WB55 board, it shows how to develop USB Device mass storage class based
...
When plugged to PC host, the P-NUCLEO-WB55 should enumerate as an USB MSC device. During the enumeration phase, device must provide host with the requested
...
Once the P-NUCLEO-WB55G USB device successfully completed the enumeration phase, a new removable drive appears in the system window and write/read
...
RTOS, ThreadX, USBXDevice, Device, USB_OTG, Full Speed, MSC, RAMDisk
