...
int main(void)
{
  ...
  /* Note: On STM32WB, both CPU1 and CPU2 must be in low-power mode
           ...
           For example, CPU1 in Stop2 mode and CPU2 in Stop2 mode
           will make system enter in Stop2 mode. */
  LL_C2_PWR_SetPowerMode(LL_PWR_MODE_STOP2);

  /* Mask wakeup with interrupt request from EXTI line 48 for CPU1*/
  LL_EXTI_DisableIT_32_63(LL_EXTI_LINE_48);

  /* Mask wakeup with interrupt request from EXTI line 48 for CPU2*/
