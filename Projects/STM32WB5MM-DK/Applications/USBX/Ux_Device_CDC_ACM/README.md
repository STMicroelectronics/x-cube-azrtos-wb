...
RTOS, ThreadX, USBX, USBXDevice, USB_OTG, Full Speed, CDC, VCP, USART, DMA.
...
### <b>Hardware and Software environment</b>
  ...
  - STM32WB5MM-DK Set-up:
    - Connect the STM32WB5MM-DK board CN6 to the PC through "USB micro A-Male " to "A-Female" cable.
