...
This application provides an example of Azure RTOS FileX and LevelX stacks usage on STM32WB5MM-DK board, it demonstrates how to create

a Fat File system on the NOR flash using FileX alongside LevelX. The application is designed to execute file operations on the S25FL128S
...
all FileX resources are created, the S25FL128S driver is initialized and a single thread is created:
...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32WB5Mxx devices.
  - This application has been tested with STMicroelectronics STM32WB5MM-DK boards Revision: MB1292 B-01.
