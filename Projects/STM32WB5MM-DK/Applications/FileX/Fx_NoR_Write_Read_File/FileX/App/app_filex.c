...
extern aPwmLedGsData_TypeDef aPwmLedGsData;
...
void fx_thread_entry(ULONG thread_input)
{
  ...
  printf("[STM32WB-Discovery]: FileX/LevelX NOR QUAD-SPI Application Start.\n");

  /* Print the absolute size of the NOR chip*/
  printf("[STM32WB-Discovery]: Total NOR Flash Chip size is: %lu bytes.\n", (unsigned long)LX_STM32_QSPI_FLASH_SIZE);
  ...
  printf("[STM32WB-Discovery]: User available NOR Flash disk space size before file is written: %lu bytes.\n", available_space_pre);
  ...
  printf("[STM32WB-Discovery]: User available NOR Flash disk space size after file is written: %lu bytes.\n", available_space_post);
  printf("[STM32WB-Discovery]: The test file occupied a total of %lu cluster(s) (%u per cluster).\n",
